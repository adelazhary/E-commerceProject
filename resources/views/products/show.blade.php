<div>
                        ...
                        <table class="min-w-full border divide-y divide-gray-200">
                            <thead>
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left bg-gray-50">
                                        <span
                                            class="text-xs font-medium tracking-wider leading-4 text-gray-500 uppercase">Description</span>
                                    </th>
                                    <th class="px-6 py-3 text-left bg-gray-50">
                                        <span
    ...
    <div
        class="hidden flex items-center justify-center fixed left-0 bottom-0 w-full h-full bg-gray-800 bg-opacity-90">
...
{{-- <div>
    <div class="max-w-4xl mx-auto px-4 py-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- Product Image -->
            <div>
                <img src="{{ $product->image }}" alt="{{ $product->name }}" class="rounded-lg shadow-lg mb-4">
            </div>
            <!-- Product Details -->
            <div>
                ...
                <!-- <button class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg shadow-md">Add to Cart</button> -->
            </div>
        </div>
    </div>
</div> --}}
