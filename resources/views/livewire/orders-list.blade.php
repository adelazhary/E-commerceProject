                                ...
                                @foreach($orders as $order)
                                    <tr class="bg-white">
                                        ...
                                        <td>
                                            ...
                                            <button wire:click="delete('delete', {{ $order->id }})" class="px-4 py-2 text-xs text-red-500 uppercase bg-red-200 rounded-md border border-transparent hover:text-red-700 hover:bg-red-300">
                                                Delete
                                            </button>
                                        </td>
                                    </tr>
