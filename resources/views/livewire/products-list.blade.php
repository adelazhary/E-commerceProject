                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div>
                        @if (session()->has('message'))
                            <div class=" mx-auto p-4 mb-4 text-sm text-white bg-green-500 rounded-md">
                                {{ session('message') }}
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <button type="button" wire:click="deleteProduct('deleteSelected')" wire:loading.attr="disabled"
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <td class="px-2 py-1 text-sm">
                                        <div>
                                            From
                                            <input wire:model.live="searchColumns.price.0" type="number"
                                        ...
                                        <div>
                                            to
                                            <input wire:model.live="searchColumns.price.1" type="number"
                                                class="w-full text-sm rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
                                        </div>
                                    </td>
                                    <td></td>
